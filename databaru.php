                            ...
                            <div class="row">
                                <div class="col-6">                                 
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="prod_name" id="prd_name" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="text" name="balai_psda" id="balai" readonly required/>
                                ...
                                <div class="col-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="text" name="p3a" id="p3a" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="text" name="kemantren" id="kemantren" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="text" name="uptd" id="uptd" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="text" name="masa_tanam1" id="tanam1" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="text" name="masa_tanam2" id="tanam2" readonly required/>
