        ...
        <hr style="border-top: 3px double green;">
                <div class="row">
                    ...
                    <div class="form-group row">
                            <label for="lname" class="col-sm-3 col-form-label text-dark">No Urut</label>
                            <div class="col-sm-6">
                                <input type="number" name="saluran_primer" class="form-control" id="lname" readonly value="<?php echo $data["id"]+1;?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        <label for="lname" class="col-sm-3 col-form-label text-dark">Daerah Irigasi</label>
                        ...
                        <div class="form-group row">
                            <label for="lname" class="col-sm-3 col-form-label text-dark">Saluran Primer</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="lname" class="col-sm-3 col-form-label text-dark">Saluran Sekunder</label>
                        ...
                        <div class="form-group row">
                            <label for="lname" class="col-sm-3 col-form-label text-dark">Saluran Tersier</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control text-uppercase" name="saluran_tersier" required="" value="" />    
                            </div>
                        </div>                    
                        <div class="form-group row">
                            <label for="email" class="col-sm-3 col-form-label text-dark">Petak</label>
                                <div class="col-sm-6">
                    ...
                    <div class="col-6">
                        <div class="form-group row">
                            <label for="email" class="col-sm-3 col-form-label text-dark">Desa</label>
                                <div class="col-sm-6">
                                <input type="text" class="form-control text-uppercase" name="desa" required=""value="" />
                                </div>                 
                        </div>            
                        <div class="form-group row">
                            <label for="luas" class="col-sm-3 col-form-label text-dark">Luas</label>
                            <div class="col-sm-6">
                                <input type="text" name="luas" class="form-control" id="fname" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="luas" class="col-sm-3 col-form-label text-dark">Jenis Tanaman 1</label>
                            <div class="col-sm-6">
                                <input type="text" name="jenis_tanam1" class="form-control text-uppercase" id="fname" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="luas" class="col-sm-3 col-form-label text-dark">Jenis Tanaman 2</label>
                            <div class="col-sm-6">
                                <input type="text" name="jenis_tanam2" class="form-control text-uppercase" id="fname" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="luas" class="col-sm-3 col-form-label text-dark">Jenis Tanaman 3</label>
                            <div class="col-sm-6">
                                <input type="text" name="jenis_tanam3" class="form-control text-uppercase" id="fname" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="luas" class="col-sm-3 col-form-label text-dark">Jenis Tanaman 4</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-warning mb-4 text-dark"><i class="fa fa-save"></i> Simpan</button>
                            </div>                            
                    </div><!--right side -->
        ...
        <table id="example" class="table table-hover table table-striped table-bordered w-auto">
            <thread>
                <tr>
                    ...
                    <th scope="col" class="text-center bg-success text-uppercase">Jenis Tanam1</th>
                    <th scope="col" class="text-center bg-success text-uppercase">Jenis Tanam2</th>
                    <th scope="col" class="text-center bg-success text-uppercase">Jenis Tanam3</th>
            ...
            <tbody>
                ...
                <td class="text-center"><?php echo $row['id']; ?></td>
                    ...
                    <td class="text-center text-uppercase"><?php echo $row['jenis_tanam1']; ?></td>
                    <td class="text-center text-uppercase"><?php echo $row['jenis_tanam2']; ?></td>
                    <td class="text-center text-uppercase"><?php echo $row['jenis_tanam3']; ?></td>
