                            ...
                            <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <?php
                                                ...
                                                echo '<select class="custom-select my-1 mr-sm-2 text-uppercase" name="petak" onchange="changeValue(this.value)">'; 
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="daerah_irigasi" id="prd_name" class="text-uppercase" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="saluran_primer" id="premier" class="text-uppercase" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="saluran_sekunder" id="sekunder" class="text-uppercase" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="jumlah_petak_tersier" id="tersier" class="text-uppercase" readonly required/>
                                ...
                                <div class="col-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="text" name="petak" id="petak" class="text-uppercase" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="text" name="desa" id="desa1" class="text-uppercase" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="text" name="luas" id="luas1" class="text-uppercase" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="text" name="tanam1" id="tanaman11" class="text-uppercase" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="text" name="tanam2" id="tanaman21" class="text-uppercase" readonly required/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                        <input type="text" name="tanam3" id="tanaman31" class="text-uppercase" readonly required/>
